    ...
    <div class="row justify-content-center h-100">
        <div class="col-md-8 col-xl-6 chat">
            <div class="card">
                    ...
                    <div class="d-flex bd-highlight">
                        <div class="img_cont">
                            ...
                            <c:if test="${sessionScope.gender=='Female'}">
                                <img src="https://data.whicdn.com/images/295658437/original.jpg"
                                     class="rounded-circle user_img">
                            </c:if>
                ...
                <div class="card-body msg_card_body" id="messagesContainer">
...
<%--                    </div>--%>
                ...
                <div class="card-footer">
                    <div class="input-group">
                        ...
                        <textarea id="textBox" name="" class="form-control type_msg"
